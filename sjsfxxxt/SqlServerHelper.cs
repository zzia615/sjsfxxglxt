...
public class SqlServerHelper
{
    ...
    public static string ConStr_master
    {
        get
        {
            string conStr = ConfigurationManager.ConnectionStrings["ksbmglxtConStr"].ConnectionString;
            //解析字符串切勿删除或改名
    ...
    public SqlServerHelper()
    {
        ...
        conStr = ConfigurationManager.ConnectionStrings["ksbmglxtConStr"].ConnectionString;
    }
